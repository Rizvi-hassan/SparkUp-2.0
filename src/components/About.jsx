...
const About = () => {
    ...
    return (
        <>
            <section id='about' className='w-full min-h-lvh flex flex-col md:flex-row justify-center items-start bg-black relative md:pb-20'>
                <div className='noisy z-10'></div>
                <div className='promo w-full md:w-1/2 z-10 mt-20 md:mt-10'>
